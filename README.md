...
## Key features:
- A wide variety of employee shift scheduling issues are classified and modeled by the same number of shifts set on every day in a schedule cycle. Currently, one to eight shift arrangements per day are supported.
