...
- The app uses reactive scheduling with constraint addition and removal to handle changing requirements. To address the new request and create the least amount of perturbation, a minimal number of altered shifts are sorted in contrast to the existing schedule.
