...
## Key Features:
- A wide variety of employee shift scheduling problems are classified by the same number of shifts set on every day in a schedule cycle. Currently, one to forty eight shifts per day in a cycle are supported.
