...
The schedule in Excel (Personnel_Schedule_176-1-12.xlsx) can be found in the “Airport Staff Schedule Examples” folder. Which staff is responsible for which shift can be adjusted according to the staff's preferences.
