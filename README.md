...
- Cost control is key to successful competition in the airline industry. It is an issue to find out how to schedule United Airlines staffs to provide necessary services to customers at the airport in order to minimize costs. The following table lists the cost per shift and the minimum number of staff required to be on duty for each two-hour interval.
